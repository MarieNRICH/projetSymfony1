...
class AdminController extends AbstractController
{
    ...
    public function index(AdminRepository $adminRepository,ContactRepository $contactRepository,ArticleRepository $articleRepository,CategoryRepository $categoryRepository): Response
    {
